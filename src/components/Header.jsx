...
const Header = () => {
  ...
  return (
    <>
      <header className="max-w-screen-2xl flex text-center justify-between items-center py-5 px-5 text-black mx-auto max-sm:px-5 max-[400px]:px-3">
        <HiBars3
        ...
        <Link
          to="/"
          className="text-5xl font-light tracking-[1.08px] max-sm:text-3xl max-[500px]:text-2xl"
        >
          COLLUSION
        </Link>
